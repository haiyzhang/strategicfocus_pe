...
![Parallel-trends event study](figures/fig_parallel_trends.png)
...
![Geographic dispersion examples — three illustrative firms](figures/fig_geographic_dispersion_examples.png)
